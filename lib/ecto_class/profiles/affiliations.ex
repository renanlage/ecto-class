defmodule EctoClass.Profiles.Affiliations do
  ...
  def get(affiliations_id) when is_binary(affiliations_id),
    do: Repo.get(Affiliation, affiliations_id)
  ...
  def join_all do
    ...
    |> select([a, u, o], %{user: u, organization: o, is_bussiness_partner: a.is_business_partner})
    |> Repo.all()
  end
end
